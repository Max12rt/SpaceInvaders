...
game_loop:
    ...
    draw_barrier_loop:
        ...
        call draw_sprite
        popa
        add ah, 100      ; # of X pixels between barriers
...
;; CODE SEGMENT DATA =================================
sprite_bitmaps:
    db 00111100b    ; New Alien 1 ("Squid")
    db 01111110b
    db 10100101b
    db 01011010b

    db 11000011b    ; New Alien 2 ("Crab")
    db 01100110b
    db 00111100b
    db 01011010b

    db 00011000b    ; New Player ship ("Delta-Wing")
    db 00111100b
    db 01111110b
    db 11011011b
